                                ...
                                <div class="auth-form">
                                    ...
                                    <form action="/store" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" placeholder="Tanggal Keberangkatan" name="tgl_berangkat" required>                                            
                                            <label class="mb-1"><strong>Nama Maskapai</strong></label>
                                            <input type="text" class="form-control" placeholder="Nama Maskapai" name="nama_maskapai" required>
