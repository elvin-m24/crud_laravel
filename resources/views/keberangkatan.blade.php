                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                            ...
                            <a href="/tambah" class="btn btn-primary">Tambah Data Keberangkatan</a>
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $kb->harga }}</td>
                                            <td>                                                                                                                                                                                          
                                                <a href="/edit/{{ $kb->id }}" class="btn btn-primary">Edit</a>
                                                <a href="/destroy/{{ $kb->id }}" class="btn btn-primary">Hapus</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                    </tbody>
